...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About · WEE PAL" },
      { name: "description", content: "Founded by Mohammed Abdul Khaliq — ethics-first AI & Robotics education, mentored by Mohammed Hassaan Ali." },
      { property: "og:title", content: "About — Meet the team behind WEE PAL" },
      { property: "og:description", content: "WEE PAL — world-class AI & Robotics education for every child." },
    ],
  }),
      ...
      <Section>
        <div className="grid gap-16 lg:grid-cols-[1.1fr_1fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 text-lg text-muted-foreground text-pretty">
              Mohammed Abdul Khaliq is just 10 years old and is the driving force behind WEE PAL,
              on a mission to make world-class AI & Robotics education accessible to every child in
              the world. With a passion for hands-on learning and a vision for ethical technology,
              he is shaping the next generation of innovators.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                to="/contact"
